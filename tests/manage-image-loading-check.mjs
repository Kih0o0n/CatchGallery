...
// Route cleanup discards metadata and repeatedly cancels observer/loader/waiters.
{
  ...
  const cleanup = Function("state", "cancelSolveImageLoading", "cancelManageImageLoading", "releaseCanvasHistory", "unlockDrawingScroll", `${pick("cleanupScreenResources")}; return cleanupScreenResources;`)(cleanupState, () => solveCancels++, () => manageCancels++, () => {}, () => unlocks++);
  cleanup(); cleanup();
